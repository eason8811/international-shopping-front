...
export const buttonRules = {
  ...
  variants: {
    ...
    contrast: {
      description: "High-contrast inverse action for dark editorial surfaces and media-heavy cards.",
      allowedRealms: ["user", "admin"],
      density: ["airy", "balanced", "compact"],
      backgroundSurface: "card",
      foregroundRole: "strong",
      ...
      preferredTypography: "titleMd",
      notes: [
        "Reserve for dark or high-contrast containers where the default primary fill would compete with surrounding content.",
      ],
    },
    ghost: {
    ...
    destructive: {
      description: "High-risk action for deletion, removal, and irreversible cancellation with restrained editorial severity.",
      allowedRealms: ["user", "admin"],
      density: ["balanced", "compact"],
      backgroundSurface: "card",
      foreground: "--ds-destructive",
      radius: "lg",
      shadow: null,
      hoverSurface: "active",
      preferredTypography: "titleMd",
      notes: [
        "Do not disguise destructive actions as neutral buttons even when the treatment stays calm.",
      ],
    },
  },
  sizes: {
