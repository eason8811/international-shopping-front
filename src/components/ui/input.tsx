...
const inputVariants = cva(
    "w-full min-w-0 border-0 border-b bg-transparent px-0 pt-3.25 pb-3.5 text-base leading-6 font-normal text-auth-ink transition-colors outline-none file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-auth-ink placeholder:text-auth-placeholder disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
    {
        variants: {
            variant: {
